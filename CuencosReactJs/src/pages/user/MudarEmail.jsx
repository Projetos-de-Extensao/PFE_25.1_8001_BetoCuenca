...
import '../../styles/user/mudarEmail.css'; // Ajuste do caminho do CSS
      ...
      <div className="container">
        ...
        <aside className="sidebar">
          ...
          <nav className="sidebar-nav">
            <Link to="/user/perfil">Informação da Conta</Link>
            <Link to="/user/meus-ingressos">Meus ingressos</Link>
            <Link to="/user/mudar-email" className="active">Mudar email</Link>
          </nav>
        </aside>
